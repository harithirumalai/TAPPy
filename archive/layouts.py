        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Div(id='sg-order-container', children=[
                        html.Label('Order'),
                    ...
                    html.Div(id='sg-window-size-container', style={'width': '75%',
                                                                   'display': 'inline-block',
                                                                   'lineHeight': '30px',
                                                                   'margin': '10px',
                                                                   'height': '60px'}),
                    ...
                    html.Div([html.A(html.Button('Download', id='download-button-2'),
                                     id='download-link-2',
                                     target='_blank'),
